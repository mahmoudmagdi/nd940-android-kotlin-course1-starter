...
class ShoeDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding =
            FragmentShoeDetailsBinding.inflate(
                inflater,
                container,
                false
        ...
        with(binding) {
            ...
            saveBtn.setOnClickListener {
                ...
                if (name.isEmpty()) {
                    Toast.makeText(context, "make sure to enter a valid name", Toast.LENGTH_LONG)
                        .show()
                ...
                if (size.isEmpty()) {
                    Toast.makeText(context, "make sure to enter a valid size", Toast.LENGTH_LONG)
                        .show()
                    return@setOnClickListener
                }
                ...
                if (description.isEmpty()) {
                    Toast.makeText(
                        context,
                        "make sure to enter a valid description",
                        Toast.LENGTH_LONG
                    )
                        .show()
                    return@setOnClickListener
